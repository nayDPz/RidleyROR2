...
namespace Ridley.SkillStates
{
    public class BaseM1 : BaseSkillState
	{
		...
		public override void FixedUpdate()
		{
            ...
            {
				if (this.cancelledFromSprinting && (base.characterBody.isSprinting || base.inputBank.sprint.justPressed) || this.earlyExitJump && (base.inputBank.jump.justPressed) && this.stopwatch >= this.duration * this.attackEndTime)
				{
